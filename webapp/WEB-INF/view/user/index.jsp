...
<div class="breadcrumbs" id="breadcrumbs">
	<ul class="breadcrumb">
		...
		<li class="active"><a href="#">User管理</a></li>
	</ul>
</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">User创建</h4>
				</div>
					...
					<div style="padding: 25px 100px 10px;">
						<form id="addFormId">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="必填参数" name="money" id="moneyAdd" />
							</div>
							<div class="input-group">
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="padding: 25px 100px 10px;">
					<form id="editFormId">
						...
						<div class="input-group">
							<span class="input-group-addon">money</span>
							<input type="text" class="form-control" placeholder="必填参数" name="money" id="moneyEdit" />
						</div>
						<div class="input-group">
							<span class="input-group-addon">createTime</span>
...
<script type="text/javascript">
	(function(jQuery) {
        ...
        $("#submitAdd").bind("click", function(e) {
            ...
            LINK_HTTP.post("/user/save", formData, function(data) {
                if (data != 0) {
                    alert("保存失败！");
        ...
        $("#user_table").find("a[class='blue']").on("click",function(e){
            ...
            LINK_HTTP.get("/user/get/"+targetId,function(result){
                if(result){
		...
		$("#user_table").find("a[class='red']").bind("click", function(e) {
			...
			if (confirm("你确定删除：" + $tds.eq(1).text())) {
				if (confirm("再次确定删除：" + $tds.eq(2).text())) {
					//提交修改用户信息
					LINK_HTTP.get("/user/delete/"+targetId, function(data) {
						if (data.code == 0) {
							LINK_HTTP.load(".main-content","/user/index");//刷新页面
						}
					}, "json");
				}
			}
