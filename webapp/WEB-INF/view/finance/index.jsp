					...
					<div style="padding: 25px 100px 10px;">
						<form id="addFormId">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="必填参数" name="orderId" id="orderIdAdd" />
							</div>
							<div class="input-group">
								<span class="input-group-addon">type</span>
								<input type="text" class="form-control" placeholder="必填参数" name="type" id="typeAdd" />
							</div>
							<div class="input-group">
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="padding: 25px 100px 10px;">
					<form id="editFormId">
						...
						<div class="input-group">
							<span class="input-group-addon">orderId</span>
							<input type="text" class="form-control" placeholder="必填参数" name="orderId" id="orderIdEdit" />
						</div>
						<div class="input-group">
							<span class="input-group-addon">type</span>
							<input type="text" class="form-control" placeholder="必填参数" name="type" id="typeEdit" />
						</div>
						<div class="input-group">
							<span class="input-group-addon">amount</span>
