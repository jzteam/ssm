					...
					<div style="padding: 25px 100px 10px;">
						<form id="addFormId">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="必填参数" name="phone" id="phoneAdd" />
							</div>
							<div class="input-group">
								<span class="input-group-addon">password</span>
								<input type="text" class="form-control" placeholder="必填参数" name="password" id="passwordAdd" />
							</div>
							<div class="input-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="必填参数" name="sex" id="sexAdd" />
							</div>
							<div class="input-group">
								<span class="input-group-addon">img</span>
								<input type="text" class="form-control" placeholder="必填参数" name="img" id="imgAdd" />
							</div>
							<div class="input-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="必填参数" name="entryTime" id="entryTimeAdd" />
							</div>
							<div class="input-group">
								<span class="input-group-addon">levaeTime</span>
								<input type="text" class="form-control" placeholder="必填参数" name="levaeTime" id="levaeTimeAdd" />
							</div>
							<div class="input-group">
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="padding: 25px 100px 10px;">
					<form id="editFormId">
						...
						<div class="input-group">
							<span class="input-group-addon">phone</span>
							<input type="text" class="form-control" placeholder="必填参数" name="phone" id="phoneEdit" />
						</div>
						<div class="input-group">
							<span class="input-group-addon">password</span>
							<input type="text" class="form-control" placeholder="必填参数" name="password" id="passwordEdit" />
						</div>
						<div class="input-group">
							<span class="input-group-addon">name</span>
						...
						<div class="input-group">
							<span class="input-group-addon">sex</span>
							<input type="text" class="form-control" placeholder="必填参数" name="sex" id="sexEdit" />
						</div>
						<div class="input-group">
							<span class="input-group-addon">img</span>
							<input type="text" class="form-control" placeholder="必填参数" name="img" id="imgEdit" />
						</div>
						<div class="input-group">
							<span class="input-group-addon">status</span>
						...
						<div class="input-group">
							<span class="input-group-addon">entryTime</span>
							<input type="text" class="form-control" placeholder="必填参数" name="entryTime" id="entryTimeEdit" />
						</div>
						<div class="input-group">
							<span class="input-group-addon">levaeTime</span>
							<input type="text" class="form-control" placeholder="必填参数" name="levaeTime" id="levaeTimeEdit" />
						</div>
						<div class="input-group">
							<span class="input-group-addon">createTime</span>
